...
# -----------------------------------------------------------------------------------------------------------
"""Validate and summarize the fixed DSV4 DSpark single-batch serving profile."""
...
def main() -> None:
    ...
    report = f"""# DeepSeek V4 DSpark single-batch serving profile

- Run: `{args.run_id}`
- Workload: `GBS1 / DP4 / EP16 / TP4 / one active DP group / Seq64 / Output128 / DSpark k=7 / temperature=0`
