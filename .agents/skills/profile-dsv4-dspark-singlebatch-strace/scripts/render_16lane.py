...
# -----------------------------------------------------------------------------------------------------------
"""Merge DSpark single-batch serving spans with sixteen Host STRACE lanes."""
...
def main() -> None:
        ...
        [
            {
                ...
                "name": "process_name",
                "pid": host_process_id,
                "args": {"name": "Simpler host STRACE (16 NPU lanes, DSpark GBS1)"},
            },
            {
                "ph": "M",
    ...
    payload = {
        ...
        "metadata": {
            "description": (
                "DSpark GBS1 serving SA_PROFILE spans and sixteen detailed Simpler "
